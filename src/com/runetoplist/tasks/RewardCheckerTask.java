...
public class RewardCheckerTask implements Runnable {
    ...
    public void run() {
        try {
            ...
            String urlParameters = "private_key=" + URLEncoder.encode(RuneTopList.PRIVATE_KEY, "UTF-8") +
            ...
            Gson gson = new Gson();
            Type listType = new TypeToken<List<VoteReward>>() {
            }.getType();
        ...
        //completes the check for the username
        RuneTopList.completeCheck(this.username);
    }
